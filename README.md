## Решаемые в данном форке задачи

1. Добавление базовой подсветки синтаксиса в YDB CLI
2. Добавление базового автодополнения при вводе SQL запросов в YDB CLI
3. Улучшение качества подсветки синтаксиса
4. Улучшение качества автодополнения
5. Улучшение качества автодополнения в Web редакторе SQL (в другом репозитории)
6. Разработка плагина VSCode для поддержки YQL (в другом репозитории)
